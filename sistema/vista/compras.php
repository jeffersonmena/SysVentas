    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Ingreso Mercadería</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="compras.html"><i class="fa fa-circle-o"></i> Compras </a></li>
            <li><a href="graficas_stock.html"><i class="fa fa-circle-o"></i> Grafica Stock</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="contrato_ventas.html"><i class="fa fa-circle-o"></i> Contrato de Compra y Venta </a></li>
